...
export const Layout = ({ children }) => {
  return (
    // <div className="layout flex flex-none min-h-screen bg-zinc-50 ">
    ...
    //   </div>
    // </div>
    <div className="layout bg-zinc-50 flex min-h-screen flex-col md:flex-row">
      <div className="top bg-white w-100 block md:hidden z-20">
        <TopNav />
      </div>
